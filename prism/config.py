"""
PRISMConfig — unified configuration for all PRISM phases.
"""
...
class PRISMConfig:
    ...
    @classmethod
    def from_preset(cls, name: str, **overrides) -> "PRISMConfig":
        """
        Create a PRISMConfig from a named preset, with optional field overrides.

        Available presets: '13b-local', '7b-local', 'cloud'

        Example:
            cfg = PRISMConfig.from_preset("13b-local", ollama_synthesis_model="codestral:22b")
        """
