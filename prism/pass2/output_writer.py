...
based on PRISMConfig.output_mode.
...
class OutputWriter:
    ...
    def _save_manifest(self) -> None:
        ...
        import os as _os
        cache_dir = getattr(self._config, "cache_dir", ".prism_cache")
    ...
    def load_manifest(cls, path: str) -> OutputManifest:
        """Load a manifest from disk for the resume path in PRISMOrchestrator."""
